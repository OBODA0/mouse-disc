...
def get_icon_drawer(item_id: str) -> Optional[Callable[[QPainter, float, float, float, QColor], None]]:
    """Get icon drawer function for an item ID"""
    icon_drawers = {
        "browser": _draw_browser,
        "terminal": _draw_terminal,
        "editor": _draw_editor,
    ...
    return icon_drawers.get(item_id)
